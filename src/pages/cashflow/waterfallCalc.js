...
export const DEFAULT_STEPS = [
  ...
  { id: '2',  label: 'Bill Pay — Immediate Bills',                    account: 'Bill Pay Checking',  tier: 'gate', auto: 'bills7' },
  { id: '3',  label: 'Debt Pay — Debt/Loan Radar',                    account: 'Debt Pay Checking',  tier: 'gate', auto: 'debtRadar7' },
  { id: '4',  label: 'Bill Pay — Floor Build',                        account: 'Bill Pay Checking',  tier: 'gate', auto: 'floorBuild' },
  { id: '5a', label: 'Debt Pay — Extra to Debt Payoff',               account: 'Debt Pay Checking',  tier: 'surplus', pct: 35 },
